...
grid = [list(str) for str in input.read().splitlines()]
...
num_accessible = 1
total_removed = 0
# worst-case O(n^4) on an approx n=150 grid, good enough.
# under standard 10^9 bound for most coding platforms
