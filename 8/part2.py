...
distances.sort()
last_merged_pair = -1
while len(circuits.parent_elts) > 1:
    last_merged_pair += 1
    _, (index_1, index_2) = distances[last_merged_pair]
    circuits.merge_groups(index_1, index_2)

_, (index_1, index_2) = distances[last_merged_pair]
last_merged_x_1 = coordinates[index_1][0]
last_merged_x_2 = coordinates[index_2][0]

with open('output.txt', 'w+') as out:
    out.write(str(last_merged_x_1 * last_merged_x_2))